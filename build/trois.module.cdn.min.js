...
`;var rr=z("ShaderMaterial",{props:{type:Object,default:()=>({uniforms:{},vertexShader:Li,fragmentShader:Gi})}},e=>new be(Q(e,["color"])));function ji(e,t,r){return e.split(t).join(r)}const ki=X.meshphong_frag.slice(0,X.meshphong_frag.indexOf("void main() {")),Oi=X.meshphong_frag.slice(X.meshphong_frag.indexOf("void main() {")),_i={uniforms:Ne.merge([Ks.phong.uniforms,{thicknessColor:{value:new K(16777215)},thicknessDistortion:{value:.1},thicknessAmbient:{value:0},thicknessAttenuation:{value:.1},thicknessPower:{value:2},thicknessScale:{value:10}}]),vertexShader:`
    #define USE_UV
    ${X.meshphong_vert}
  `,fragmentShader:`
    #define USE_UV
